...
#define AUX_AIRCON1_HDR_MARK    9000 // 9260 <-- Arduino decoder printouts
#define AUX_AIRCON1_HDR_SPACE   4580 // 4540
#define AUX_AIRCON1_BIT_MARK    600  // 540
#define AUX_AIRCON1_ONE_SPACE   1740 // 1640
#define AUX_AIRCON1_ZERO_SPACE  500  // 480
...
class AUXCentekHeatpumpIR : public HeatpumpIR
{
  public:
    AUXCentekHeatpumpIR();
